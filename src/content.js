export default [
    {
        ...
        text: `A clone of one of my favorite games, Minesweeper. Written in Java using the Java Swing framework. This is an ongoing pet project that is planned to have a rich feature set that caters towards competitive players.
...
This project is meant as a first step into learning how to structure complex games, and as more general experience with object oriented design. `,
    ...
    },
    {
        type: 'post',
        title: 'FES 526',
        text: `FES 520 is a small data visualization project written in ReactJS. It uses react-vis and react-animated-number to smoothly animate between different years in the dataset. 
    ...
    },
    {
        type: 'post',
        title: 'SOIL 360',
        text: `SOIL 360 is a crop rotation planner for agriculture students. Its data hierarchy is as follows: Crops (internally referred to as Events) are the blue and cyan boxes take up space on the calendar, they have a start, end, and a type. Examples of crops are Carrots or Winter Squash.
